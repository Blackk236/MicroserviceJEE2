...
import sn.isi.m2gl.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).cni(DEFAULT_CNI).adresse(DEFAULT_ADRESSE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).cni(UPDATED_CNI).adresse(UPDATED_ADRESSE);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).cni(UPDATED_CNI).adresse(UPDATED_ADRESSE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.cni(UPDATED_CNI).adresse(UPDATED_ADRESSE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).cni(UPDATED_CNI).adresse(UPDATED_ADRESSE);
